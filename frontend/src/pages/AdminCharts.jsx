...
export default function AdminChartsPage() {
    ...
    if (loading)
        return <div className="p-10 text-center font-bold">Analysing Data...</div>;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="rounded-3xl border-none shadow-xl shadow-slate-200/50 bg-white">
            ...
            <CardContent className="h-[400px]">
              {appointmentData.length === 0 ? (<div className="h-full flex items-center justify-center text-slate-400 italic">No appointment data yet.</div>) : (<ResponsiveContainer width="100%" height="100%">
                  <PieChart>
