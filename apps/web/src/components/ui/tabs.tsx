...
export function TabsListRoot({ className, children }: { className?: string; children: React.ReactNode }) {
  return (
...
export function TabsTriggerRoot({ value, className, children }: { value: string; className?: string; children: React.ReactNode }) {
...
export function TabsContentRoot({ value, className, children }: { value: string; className?: string; children: React.ReactNode }) {
  const ctx = React.useContext(TabsContext);
